      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  ...
                  <div class="dropdown-item-desc">
                    <b>Ananda Silvia</b>
                    <p>Nduy, Jangan lupa kerjain tugas!!</p>
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  ...
                  <div class="dropdown-item-desc">
                    <b>Syarifani Fauziah</b>
                    <p>Mandut semangattttt masih panjang perjalanan kitaa</p>
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-list-content dropdown-list-icons">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="dropdown-item-desc">
                    <b>Ada beberapa</b> pesan <b>yang belum</b> anda baca
                    <div class="time">12 Hours Ago</div>
                  </div>
                </a>
                <a href="#" class="dropdown-item">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi,Amanda Aprilia Permata Putri</div></a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="menu-header">Praktikum</li>
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Daftar Praktik</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="satu.php">Week 1</a></li>
                <li><a class="nav-link" href="dua.php">Week 2</a></li>
                <li><a class="nav-link" href="tiga.php">Week 3</a></li>
              </ul>
            </li>
      </div>
